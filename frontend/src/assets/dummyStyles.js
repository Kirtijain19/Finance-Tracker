...
export const sidebarStyles = {
  // Layout and container styles
  sidebarContainer: {
    base: "hidden lg:flex flex-col pt-2 fixed top-16 bottom-0 z-30"
  },
  
  sidebarInner: {
    base: "bg-white border-r border-gray-200 shadow-md h-full flex flex-col transition-all duration-300",
    collapsed: "w-20",
    expanded: "w-64"
  },
  ...
  userInitials: {
    base: "w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-400 to-teal-500 flex items-center justify-center text-white font-bold text-lg"
  },
  ...
  menuItem: {
    base: "relative flex items-center gap-3 py-2.5 rounded-lg font-medium transition-all duration-200",
  ...
  // Toggle button
  toggleButton: {
    base: "absolute -right-3 top-10 z-20 w-6 h-6 bg-white border border-gray-300 rounded-full flex items-center justify-center text-gray-500 hover:text-teal-600 hover:border-teal-400 hover:bg-teal-50 transition-all"
  },
  ...
  footerLink: {
    base: "flex items-center gap-3 py-2 rounded-lg font-medium text-gray-600 hover:text-teal-700 hover:bg-gray-50",
    collapsed: "justify-center"
  },
  
  logoutButton: {
    base: "flex items-center gap-3 py-2 rounded-lg font-medium text-gray-600 hover:text-red-600 hover:bg-red-50 w-full mt-1",
    collapsed: "justify-center"
  },
